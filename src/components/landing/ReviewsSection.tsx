...
const reviews = [
  {
    ...
    text: "Experience incroyable du debut a la fin. Le Dr. Benali a pris le temps de tout m'expliquer avant l'intervention. Mon implant est parfait, aucune douleur. Le personnel est aux petits soins.",
  ...
  },
  {
    ...
    rating: 5,
    date: "Il y a 1 mois",
    text: "J'avais tres peur du dentiste mais l'equipe de DentaCare m'a mise en confiance des mon arrivee. Le blanchiment a donne un resultat spectaculaire. Je souris enfin sans complexe.",
  ...
  },
  {
    ...
    rating: 5,
    date: "Il y a 5 jours",
    text: "Hollywood Smile parfait. Mes amies n'en reviennent pas du resultat. Le Dr. Benali est un vrai artiste. Je recommande les yeux fermes a toute personne qui hesite.",
